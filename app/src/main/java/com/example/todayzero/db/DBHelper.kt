...
class DBHelper(context: Context):SQLiteOpenHelper(context,DATABASE_NAME,null,DATABASE_VERSION){
    ...
    companion object {
        ...
        val SQL_CREATE_TABLE_DEALS="CREATE TABLE ${deals.TABLE_NAME}"+
                ...
                deals.KEY_DATE+" TEXT,"+ deals.KEY_NAME+" TEXT,"+deals.KEY_PRICE+" INTEGER"+deals.KEY_CATEGORY+"TEXT);"
            ...
            if(cursor!=null){
                ...
                with(cursor){
                    while(moveToNext()){
                        ...
                        var id=cursor.getString(cursor.getColumnIndex(DBHelper.users.KEY_ID))
    ...
    fun getDeals():ArrayList<deal>{
        ...
        while(cursor.moveToNext()){
            ...
            val deal=deal(did,sname,date,price,category)
            dealList.add(deal)
        }
        return dealList
    }
